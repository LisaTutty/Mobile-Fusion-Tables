...
var MapsLib = MapsLib || {}; MapsLib.schemaVersion = 2;
    ...
    MapsLib.fusionTableId = "15a9CncEM9_2zLP7buPbI052cxynCuOBfq4DWbUsZ";//"Publish Test Collaborative Projects" Fusion Table
...
*/
    ...
    aboutPage: " \
        <h3>About {title}</h3> \
        <p>  This particular application uses project information for GIS Collaborative Projects at Fleming College in Lindsay, Ontario, Canada. </p> \
		<p> This is a demonstration of a Mobile Template using Fusion Tables.    Developed by SF Brigade for Code For America, it is an adaptation of Derek Eder's searchable Fusion Table template, licensed under the <a href='https://github.com/derekeder/FusionTable-Map-Template/wiki/License' target='_blank'>MIT License</a>.  </p> \
...
*/
   ...
   locationColumn:  "Project Location",
